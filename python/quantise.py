...
parser.add_argument('--frac_bits', type=int, nargs=1, default=8, help='fractional bits')
...
parser.add_argument('--filenames', metavar='F', type=str, nargs='+', default=["test_params"], help='file names to be converted')

args = parser.parse_args()
int_bits = int(args.int_bits[0])
frac_bits = int(args.frac_bits[0])
in_filepath = args.in_filepath[0]
out_filepath = args.out_filepath[0]
