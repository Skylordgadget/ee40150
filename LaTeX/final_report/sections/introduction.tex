...
Thus, a significant amount of power and, crucially, time is taken to wirelessly transmit a large quantity of information sequentially (\textbf{Fig \ref{fig:comm_example}}) \cite{RN1}. % TODO redo the diagram from the paper to include transmission time as well as power consumption
